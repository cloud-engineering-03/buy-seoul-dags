...
def insert_init_data():
    ...
    with engine.begin() as conn:
        ...
        conn.execute(text("""
            ...
            "floor" int,
            "building_area" double float,
            "land_area" double float,
            "transaction_amount" double float,
        ...
        #         base_district_code CHAR(5),
        #         adjacent_district_code CHAR(5),
        #         distance DOUBLE float PRECISION,
        ...
        #         station_name VARCHAR(50),
        #         station_name_eng VARCHAR(50),
        #         latitude DOUBLE float PRECISION,
        #         longitude DOUBLE float PRECISION,
        ...
        #     floor int4 NULL,
        #     building_area DOUBLE float PRECISION NULL,
        #     land_area DOUBLE float PRECISION NULL,
        #     transaction_amount DOUBLE float PRECISION NULL,
